...
INSERT INTO `role` (title, salary, department_id)
VALUES ("Sales person",80000,1); -- 2
INSERT INTO `role` (title, salary, department_id)
VALUES ("Lead Engineer",150000,2); -- 3
INSERT INTO `role` (title, salary, department_id)
VALUES ("Software Engineer",120000,2); -- 4
INSERT INTO `role` (title, salary, department_id)
VALUES ("Accountant",125000,3); -- 5
INSERT INTO `role` (title, salary, department_id)
VALUES ("Legal Team Lead",250000,4); -- 6
INSERT INTO `role` (title, salary, department_id)
VALUES ("Lawyer",190000,4); -- 7
